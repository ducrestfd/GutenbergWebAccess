...
/**
 * Composable function that displays the "About" screen of the Gutenberg Listen application.
 *
...
fun About(navController: NavController) {
    ...
    val fullTextLicense = "Gutenberg Listen's raison d'être is to provide simple access to " +
    ...
    val gitHubAddress = "https://github.com/ducrestfd/gutenberglisten"
    val gitHubText = "Code for this project is available at https://github.com/ducrestfd/gutenberglisten"
    ...
    • “Home” and “Back” button wording and position are now consistent and placed above the “Gutenberg Listen” title on sub screens. 
    ...
    Future Updates:
    • Check for internet connection to avoid infinite wait. 
